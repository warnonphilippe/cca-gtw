...
import be.civadis.gtw.multitenancy.CustomGatewayUserInfoTokenServices;
...
import be.civadis.gtw.security.oauth2.SimpleAuthoritiesExtractor;
import be.civadis.gtw.security.oauth2.SimplePrincipalExtractor;
...
public class OAuth2TokenServicesConfiguration {
    ...
    //Voir si encore nécessaire dans la nouvelle version
    @Bean
    @Primary
