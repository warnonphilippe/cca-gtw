...
describe('Service Tests', () => {
    describe('BonCommande Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(BonCommandeService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'biz/api/bon-commandes';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a BonCommande', () => {
                service.create(new BonCommande(null)).subscribe(received => {
            ...
            it('should update a BonCommande', () => {
                service.update(new BonCommande(123)).subscribe(received => {
            ...
            it('should return a BonCommande', () => {
