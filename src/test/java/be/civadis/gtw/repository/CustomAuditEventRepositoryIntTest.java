package be.civadis.gtw.repository;

import be.civadis.gtw.GtwApp;
import be.civadis.gtw.config.Constants;
import be.civadis.gtw.config.audit.AuditEventConverter;
import be.civadis.gtw.domain.PersistentAuditEvent;
...
import static be.civadis.gtw.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
